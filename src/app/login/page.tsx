...
export default function LoginPage() {
  ...
  // Staff users are sent directly to the admin panel regardless of pending plan.
  ...
  const handleGoogleSuccess = async (accessToken: string) => {
    ...
    try {
      ...
      // Retry once after a brief pause — access tokens sometimes take a moment to propagate
      try {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="text-sm font-normal text-gray-700">Password</label>
                <Link
